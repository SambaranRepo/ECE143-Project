...
csv_file = open(parent + '/iclr_2016-2020.csv', 'w')
...
for iclr in tqdm(iclr_links):
    ...
    for section in tqdm(soup.find_all('div', class_='maincard narrower poster')): 
        try:
            ...
            link = f'https://iclr.cc/Conferences/{year}/Schedule?showEvent=' + id
            ...
            for item in author_link: 
                ...
                # print(author_id)
                auth_profile_link = f"https://iclr.cc/Conferences/{year}/Schedule?showSpeaker={author_id}"
